...
![Zenmap topology of the VLAN 60 segment](topology.png)
...
![Reverse shell fails - no session created](reverse-fail.png)
...
![Samba bind-shell exploit landing a root shell](samba-root.png)

🎥 **[Watch the terminal recording of the exploit landing root](samba-root.mp4)**
...
![Samba exploit alert (CVE-2017-7494) alongside CrowdSec bans](notifications-samba-cve.png)
